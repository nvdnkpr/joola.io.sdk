...
joolaio.visualisation.report.Timeline.prototype.init = function (options, container) {
  ...
  _this.bgcolor = this.options.bgcolor;
  ...
  $(matchedContainers).each(function (index, item) {
    ...
    var _bgcolor = $(item).attr('data-bgcolor');
    var _hide_xaxis = $(item).attr('data-hide-xaxis');
    if (_height)
      _this.options.height = _height;
    if (_bgcolor)
      _this.options.bgcolor = _bgcolor;
    if (_hide_xaxis)
      _this.options.hide_xaxis = _hide_xaxis;
...
joolaio.visualisation.report.Timeline.prototype.drawChart = function (Container) {
  ...
  _html += '<div class="mainmetricwrapper"></div><!--<button class="jio-btn mainmetricwrapper dropdown-toggle dropdown" data-toggle="dropdown">';
  _html += '<span class="joolaio metricname"></span>&nbsp;<span class="jio-caret"></span>';
  _html += '</button>-->';
  ...
  _html += '<span class="joolaio secondarymetricname">Select a metric...</span>&nbsp;<span class="jio-caret"></span></a>-->';
  ...
  _html += '<!--<button class="jio-btn" data-id="Timeline">';
  _html += 'Timeline</button>';
  _html += '<button class="jio-btn" data-id="Minute">';
  _html += 'Minute</button>';
  _html += '<button class="jio-btn" data-id="Hour">';
  _html += 'Hour</button>-->';
  _html += '<button class="jio-btn" data-id="Day">';
  _html += 'Day</button>';
  _html += '<button class="jio-btn " data-id="Week">';
  _html += 'Week</button>';
  _html += '<button class="jio-btn" data-id="Month">';
  _html += 'Month</button>';
  _html += '</div>';
  _html += '</div>';
  ...
  switch (_this.Resolution) {
    case 'Day':
      $('.jio-btn[data-id="Day"]').addClass('active');
      break;
    case 'Week':
      $('.jio-btn[data-id="Week"]').addClass('active');
      break;
    case 'Month':
      $('.jio-btn[data-id="Month"]').addClass('active');
      break;
    default:
      break;
  }
  ...
  var $metlist = '<ul class="joolaio metriccontainer jio-dropdown-menu">';
  $metlist += '</ul>';
  $metlist = $($metlist);
  ...
  _this.Chart = new Highcharts.Chart({
    chart: {
      backgroundColor: _this.options.bgcolor,
        ...
        selection: function (event) {
          if (event.xAxis) {
            ...
            if (_this.Resolution != resolution && resolution != '') {
              ...
              var $button = $('.resolutionpicker').find('.jio-btn[data-id="' + resolution + '"]');
    ...
    xAxis: {
      ...
      labels: {
        ...
        fontFamily: 'Signika',
        enabled: _this.options.hide_xaxis,
  ...
  $('.charttype').find('.jio-btn').each(function () {
    $(this).off('click');
    $(this).click(function () {
  ...
  $('.resolutionpicker').find('.jio-btn').each(function () {
    $(this).off('click');
    $(this).click(function () {
