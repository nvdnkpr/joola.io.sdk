...
joolaio.visualisation.picker.Dimensions.prototype.setSelected = function (sender, dimensionname, multiple) {
    ...
    if (dimensionname != '' && _this.options.showselected) {
        $(_this.container.find('.jbtn')[0]).html(dimensionname + '<span class="jio-caret"></span>');
        ...
        var s = ' + add dimension <span class="jio-caret"></span>';
...
joolaio.visualisation.picker.Dimensions.prototype.baseHTML = function (sender) {
    ...
    if (_this.options.type == 'button') {
        $html.append('<a class="jio-btn jbtn">' + _this.options.placeholdertext + ' <b class="jio-caret"></b></a>');
    }
    else if (_this.options.type == 'none') {
        $html.append('<bb class="jbtn">' + _this.options.placeholdertext + ' <b class="jio-caret"></b></bb>');
    }
    else {
