...
joolaio.visualisation.report.Editor.prototype.init = function (sender, options) {
    ...
    var $btn_submit = $('<a class="jio-btn save">Save</a>');
    var $btn_cancel = $('<a class="jio-btn cancel">Cancel</a>');
    var $btn_delete = $('<a class="jio-btn delete">Delete</a>');
...
//console.log(tab_type);
    ...
    $type.append('<div class="controls"><div class="btn-group" data-toggle="buttons-radio">' +
        '<a class="jio-btn btn_type_explorer">Explorer</a>' +
        '<a class="jio-btn btn_type_table">Table</a>' +
        '<a class="jio-btn btn_type_histogram">Histogram</a>' +
        '<!--<a class="jio-btn btn_type_geo">Geographical</a>-->' +
        '<a class="jio-btn btn_type_overview">Overview</a>' +
        '</div></div>');

    $type.find('.jio-btn.btn_type_explorer').off('click');
    $type.find('.jio-btn.btn_type_explorer').on('click', function (e) {
        _this.buildTab(_this, {tab:$tab, type:'explorer'});
    });
    $type.find('.jio-btn.btn_type_table').off('click');
    $type.find('.jio-btn.btn_type_table').on('click', function (e) {
        _this.buildTab(_this, {tab:$tab, type:'table'});
    });
    $type.find('.jio-btn.btn_type_geo').off('click');
    $type.find('.jio-btn.btn_type_geo').on('click', function (e) {
        _this.buildTab(_this, {tab:$tab, type:'geo'});
    });
    $type.find('.jio-btn.btn_type_overview').off('click');
    $type.find('.jio-btn.btn_type_overview').on('click', function (e) {
        _this.buildTab(_this, {tab:$tab, type:'overview'});
    });
    $type.find('.jio-btn.btn_type_histogram').off('click');
    $type.find('.jio-btn.btn_type_histogram').on('click', function (e) {
        _this.buildTab(_this, {tab:$tab, type:'histogram'});
    });

    $type.find('.jio-btn.btn_type_explorer').removeClass('active');
    $type.find('.jio-btn.btn_type_table').removeClass('active');
    $type.find('.jio-btn.btn_type_geo').removeClass('active');
    $type.find('.jio-btn.btn_type_overview').removeClass('active');
    $type.find('.jio-btn.btn_type_histogram').removeClass('active');

    //console.log(oTab.type);

    switch (oTab.type) {
        case 'explorer':
            $type.find('.jio-btn.btn_type_explorer').addClass('active');
            break;
        case 'table':
            $type.find('.jio-btn.btn_type_table').addClass('active');
            break;
        case 'geo':
            $type.find('.jio-btn.btn_type_geo').addClass('active');
            break;
        case 'overview':
            $type.find('.jio-btn.btn_type_overview').addClass('active');
            break;
        case 'histogram':
            $type.find('.jio-btn.btn_type_histogram').addClass('active');
            break;
        default:
            break;
    }
    ...
    if (oTab.type == 'explorer') {
        ...
        $add_mgroup.append('<a class="jio-btn btn_addgroup">+ Add metric group</a>');
        $add_mgroup.find('.jio-btn').off('click');
        $add_mgroup.find('.jio-btn').on('click', function (e) {
            var mgroup = {
