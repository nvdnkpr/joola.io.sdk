...
//        _this.sortColumnIndex = 1;
  ...
  if (!_this.isother) {
    ...
    $('.japi.other.picker .jbtn').html('Other <span class="jio-caret"></span>');
  }
...
joolaio.visualisation.report.Table.prototype.draw = function (Container) {
  ...
  _html = '<div class="btn-group"><button class="jio-btn prev disabled"></button><button class="jio-btn next disabled"></button></div>';
  ...
  _html += 'Other';
  _html += '<span class="jio-caret" style=""></span></li>' +
  ...
  $tablecontrol.append('<div class="secondary btn-group"><button class="jio-btn secondarywrapper dropdown-toggle dropdown" data-toggle="dropdown"><span class="secondarybutton">Add secondary dimension...</span>&nbsp;<span class="jio-caret"></span></button><div class="secondarylist"><ul class="joolaio secondarylistcontainer jio-dropdown-menu"></ul></div></div>');
  ...
  $charttype.append('<button rel="tooltip" title="Table" class="jio-btn btn_table active">' +
    '<img src="' + joolaio.contenthost + '/assets/img/glyphicons_114_list.png""/>' +
    '</i></button>');
  $charttype.append('<button rel="tooltip" title="Pie chart" class="jio-btn btn_pie ' + (_this.DateBox.comparePeriod ? 'disabled' : '') + '" ' + (_this.DateBox.comparePeriod ? 'disabled="disabled"' : '') + '>' +
    '<img src="' + joolaio.contenthost + '/assets/img/glyphicons_042_pie_chart.png"/>' +
    '</button>');
  $charttype.append('<button rel="tooltip" title="Performance" class="jio-btn btn_perf ' + (_this.DateBox.comparePeriod ? 'disabled' : '') + '" ' + (_this.DateBox.comparePeriod ? 'disabled="disabled"' : '') + '>' +
