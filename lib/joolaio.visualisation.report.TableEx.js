...
joolaio.visualisation.report.TableEx.prototype.draw = function (Container) {
   ...
   // $header.append(_html);
    ...
    $tablecontrol.append('<div class="secondary btn-group"><button class="jio-btn secondarywrapper dropdown-toggle dropdown" data-toggle="dropdown"><span class="secondarybutton">Secondary dimension...</span>&nbsp;<span class="jio-caret"></span></button><div class="secondarylist"><ul class="joolaio secondarylistcontainer jio-dropdown-menu"></ul></div></div>');
    ...
    $charttype.append('<button rel="tooltip" title="Table" class="jio-btn btn_table active">' +
        ...
        '</i></button>');
    $charttype.append('<button rel="tooltip" title="Pie chart" class="jio-btn btn_pie">' +
        '<img src="' + joolaio.hostname + '/assets//img/glyphicons_042_pie_chart.png"/>' +
        '</button>');
    $charttype.append('<button rel="tooltip" title="Performance" class="jio-btn btn_perf">' +
